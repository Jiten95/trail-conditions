...
const RISK_ACCENT: Record<AvalancheRiskLevel, string> = {
  low: "accent-good",
        ...
        {tab === "report" ? (
          ...
          <>
            ...
            <div className="metrics-row">
              ...
              <div className={`metric-col ${RISK_ACCENT[avalancheLevel]}`}>
                <div className="metric-icon">
                  <AlertTriangleIcon />
                </div>
            ...
            <p className="metrics-caption">
              {avalancheIsOfficial ? (
                ...
                <>
                  ...
                  right now (seasonal — winter/spring only).
                </>
              )}
            </p>
